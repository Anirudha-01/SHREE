...
<head>
    ...
    <link rel="stylesheet" href="assets/styles.css"> <!-- External CSS -->
</head>
...
<body>
    ...
    <!-- Hero Section -->
   <section class="hero" style="background: url('assets/tinu.jpg') no-repeat center center/cover; height: 400px;">
    <h1>Welcome to Shree Enviro Tech !</h1>
    <h4>Your trusted partner in Environmental Engineering & Biomass Power Plants.</h4>
